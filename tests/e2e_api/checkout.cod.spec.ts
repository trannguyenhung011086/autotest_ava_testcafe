...
describe('Checkout API - Logged in - COD ' + config.baseUrl + config.api.cart, () => {
    ...
    test('POST / checkout with COD - expired voucher', async () => {
        item = await request.getInStockProduct(config.api.featuredSales, 1)
        await request.addToCart(item.id, cookie)
        account = await request.getAccountInfo(cookie)
    ...
    test('POST / checkout with COD - not started voucher', async () => {
        item = await request.getInStockProduct(config.api.featuredSales, 1)
        await request.addToCart(item.id, cookie)
        account = await request.getAccountInfo(cookie)
    ...
    test('POST / checkout with COD - redeemed voucher', async () => {
        item = await request.getInStockProduct(config.api.featuredSales, 1)
        await request.addToCart(item.id, cookie)
        account = await request.getAccountInfo(cookie)
    ...
    test('POST / checkout with COD - already used voucher', async () => {
        item = await request.getInStockProduct(config.api.featuredSales, 1)
        await request.addToCart(item.id, cookie)
        account = await request.getAccountInfo(cookie)
    ...
    test('POST / checkout with COD - not allowed to used voucher', async () => {
        item = await request.getInStockProduct(config.api.featuredSales, 1)
        await request.addToCart(item.id, cookie)
        account = await request.getAccountInfo(cookie)
