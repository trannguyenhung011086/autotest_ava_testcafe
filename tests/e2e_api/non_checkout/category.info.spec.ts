...
test("GET / get featured sales - apparel", async t => {
	let sales = await requestSale.getSales(
		config.api.cateApparel + "/sales/featured"
	);
...
test("GET / get featured sales - accessories", async t => {
	let sales = await requestSale.getSales(
		config.api.cateAccessories + "/sales/featured"
	);
...
test("GET / get featured sales - bags shoes", async t => {
	let sales = await requestSale.getSales(
		config.api.cateBagsShoes + "/sales/featured"
	);
...
test("GET / get featured sales - health beauty", async t => {
	let sales = await requestSale.getSales(
		config.api.cateHealthBeauty + "/sales/featured"
	);
...
test("GET / get featured sales - home lifestyle", async t => {
	let sales = await requestSale.getSales(
		config.api.cateHomeLifeStyle + "/sales/featured"
	);
...
test("GET / get current sales - apparel", async t => {
	let featured = await request.get(
		config.api.cateApparel + "/sales/featured?limit=1"
	);

	let sales = await requestSale.getSales(
		config.api.cateApparel + "/sales/current?excludeId=" + featured.body.id
	);
...
test("GET / get current sales - accessories", async t => {
	let featured = await request.get(
		config.api.cateAccessories + "/sales/featured?limit=1"
	);

	let sales = await requestSale.getSales(
		config.api.cateAccessories +
			"/sales/current?excludeId=" +
			featured.body.id
	);
...
test("GET / get current sales - bags shoes", async t => {
	let featured = await request.get(
		config.api.cateBagsShoes + "/sales/featured?limit=1"
	);
...
test("GET / get current sales - health beauty", async t => {
	let featured = await request.get(
		config.api.cateHealthBeauty + "/sales/featured?limit=1"
	);
...
test("GET / get current sales - home lifestyle", async t => {
	let featured = await request.get(
		config.api.cateHomeLifeStyle + "/sales/featured?limit=1"
	);
